...
snv_mutation_file='/n/data1/bwh/pathology/miller/lab/AD_hg19/annovar/snv_list.combined.variant_function'
indel_mutation_file='/n/data1/bwh/pathology/miller/lab/AD_hg19/annovar/indel_list.combined.variant_function'
snv_permutation_file='/n/data1/bwh/pathology/miller/lab/AD_hg19/permute/annovar/perms_by_cell_snv.combined.variant_function'
...
############################################################################
#average_mut_num <- readRDS(paste0(workdir,'AD_snv_permutation_sig.rds'))
